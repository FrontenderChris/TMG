...
function airi_footer_credits() {
	...
	<div class="site-info col-md-12">
        Copyright © 2020 <a href="http://maringroup.co.nz">The Marin Group</a>&nbsp;|&nbsp;All rights reserved.
<!--        --><?php //if ( $credits == '' ) : ?>
<!--			<a href="--><?php //echo esc_url( __( 'https://maringroup.co.nz/', 'maringroup' ) ); ?><!--">--><?php
//				/* translators: %s: CMS name, i.e. WordPress. */
//				printf( esc_html__( '', 'maringroup' ), '' );
//			?><!--</a>-->
<!--			<span class="sep"></span>-->
<!--			--><?php
//				/* translators: 1: Theme name, 2: Theme author. */
//				printf( esc_html__( ' | All rights reserved.', 'maringroup' ), 'aThemes', '' );
//			?>
<!--		--><?php //else : ?>
